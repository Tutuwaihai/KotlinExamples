...
fun findRecipe(title:String = "", ingredient:String="", isVegetarian:Boolean = false, difficulty:String = "") : Array<Recipe>{
    //123
...
fun main (args: Array<String>) {
    ...
    println("r1 === r2? ${r1 === r2}")
    println("r1 == r3? ${r1 == r3}")
    val (title, isVegetarian, mainIngredient, difficulty) = r1
